...
require "C:/xampp/htdocs/Mysteriamain/vendor/autoload.php" ;
$mail = new PHPMailer;
                    ...
                    if (mysqli_num_rows($insertionResult)>0 && $result) {
                        ...
                        if ($mail->send()) {
                            ...
                            $_SESSION['sent2'] = <<<eol
                                ...
                                eol;
                            header("Location: http://localhost/Mysteriamain/shared/signup.php#pass_reset2");
                            ignore_user_abort();
            ...
            <?php
                if(isset($_POST['sub_btn2'])){
                    ...
                    else
                    {
                            ...
                            header("Location: http://localhost/Mysteriamain/shared/signup.php#myForm");
                            die();
                    }
