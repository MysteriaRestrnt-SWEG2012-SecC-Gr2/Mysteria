        ...
        <div class="header">
            <div id="navigation">
                <nav id="letters">
                    ...
                    <a href="../review/Feedback2.php">Feedback</a>
                </nav>
                <nav id="logos">
                    <div id="span"><span onclick="openNav()" style="font-size:140%; color: seashell; cursor:pointer;">&#9776;</span></div>
                    <a href="../home/home.php">&#8962;</a>
                    <a href="../review/about us2.php">&#8505;</a>
                    <a href="../review/contact.php">&#9743;</a>
                    <a href="../review/Feedback2.php">&#x1f5e8;</a>
                </nav>
            </div>
            <div id="logo">
                <a href="../home/home.php"><img id="Mystlogo" src="../../resources/images/MLOGO.png" alt="Mysteria Logo"></a>
            </div>
        </div>
    </div>
    <div id="search">
