...
<div id="sideNav">
        ...
        <hr>
        <ul>
             <li><a href="../public/menu_bar/FoodMenu.php">Food Menu </a></li><hr/>
            <li><a href="../public/reservation/reservationnew.php#popup1">Table reservation </a></li><hr/>
            ...
            <div class="header">
                <div id="navigation">
                    <nav id="letters">
                        ...
                        <a href="../public/review/about us2.php">About us</a>
                        <a href="../public/review/contact.php">Contact us</a>
                        <a href="../public/review/about us2.php#popup4">Feedback</a>
                    </nav>
                    <nav id="logos">
                        <div id="span"><span onclick="openNav()"
                                style="font-size:140%; color: seashell; cursor:pointer;">&#9776;</span></div>
                        <a href="../public/home/home.php">&#8962;</a>
                        <a href="../public/review/about us2.php">&#8505;</a>
                        <a href="../public/review/contact.php">&#9743;</a>
                        <a href="../public/review/about us2.php#popup4">&#x1f5e8;</a>
                    </nav>
                </div>
                <div id="logo">
                    <a href="../public/home/home.php"><img id="Mystlogo" src="../resources/images/MLOGO.png"
                            alt="Mysteria Logo"></a>
                </div>
            </div>
        </div>
        <div id="search">
            <form id="srchform" role="search" method="GET" action="searching.php" onsubmit="return search()" >
