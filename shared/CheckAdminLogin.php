...
if (!isset($_SESSION['userID'])&&!isset($_SESSION['user_grp']))
{
    ...
    if (isset($_SESSION['start']) && ((time() - $_SESSION['start']) >600)) {
        ...
        echo '<script type ="application/JavaScript"> alert ("Your login has expired. Please login again"); window.location.assign("http://localhost/Mysteria/shared/signup.php"); </script>'; 
    }
