...
require 'C:/xamppp/composer/vendor/autoload.php';
$mail = new PHPMailer;
    ...
    if (!$connectVariable)
        ...
        {             
            ...
            $number=$row["table_number"];
                ...
                {
                    echo '<script type ="application/JavaScript"> window.location.assign("http://localhost/Mysteriamain/public/reservation/reservationnew.php#popup3"); </script>';
                    exit();
                }
                }
                else 
