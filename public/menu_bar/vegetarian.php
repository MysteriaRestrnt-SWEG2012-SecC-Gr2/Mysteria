...
<head>
    ...
    <title>Mysteria Vegetarian menu</title>
    ...
    <div class="upper-inner">
      <div id="heroCarousel" class="carousel slide carousel-fade">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active" style="background-image: url(../../resources/images/vegies.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown"><span>Mysteria</span> Vegetarian menu</h2>
                <p class="animate__animated animate__fadeInUp">Diet Food is not a Meal, It is a Medicine.<br>
                                                                    - Amit Kalantri</p>
              </div>
            </div>
          </div>
        ...
        <section>
            ...
            <form action="../../shared/addToCart.php" method="POST">
                ...
                printMenu("Vegetarian",$sort,$filter);
                ?>
                </div> 
