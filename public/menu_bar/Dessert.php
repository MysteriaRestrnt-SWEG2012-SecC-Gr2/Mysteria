...
<head>
    ...
    <title>Mysteria Mysteria Dessert menu</title>
    ...
    <div class="upper-inner">
      <div id="heroCarousel" class="carousel slide carousel-fade">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active" style="background-image: url(../../resources/images/Dessertbg.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown"><span>Mysteria</span> Dessert menu</h2>
                <p class="animate__animated animate__fadeInUp">Desserts are the fairy tsles of the kitchen - A HAPPY-EVER-AFTER to supper.<br>
                                                                    - Anonymous</p>
              </div>
            </div>
          </div>
        ...
        <div class="col-12 sortBox">
                <form method="GET" action="Dessert.php">
