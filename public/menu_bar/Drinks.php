...
<head>
    ...
    <title>Mysteria Drinks menu</title>
    ...
    <div class="upper-inner">
      <div id="heroCarousel" class="carousel slide carousel-fade">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active" style="background-image: url(../../resources/images/Drinkbg.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown"><span>Mysteria</span> Drinks menu</h2>
                <p class="animate__animated animate__fadeInUp">Every Empty Bottle is Filled With Stories.<br>
                                                                    - Anonymous</p>
              </div>
            </div>
          </div>
